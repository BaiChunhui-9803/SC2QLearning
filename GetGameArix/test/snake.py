"""
https://blog.csdn.net/qq_34445388/article/details/108959547
"""
...
class HDP():
    ...
    def plot_curve(self, s, u, V,cost,modelloss):
        ...
        plt.grid()
        plt.savefig(r'HDP_Model_loss.png')
        plt.show()
        pass
